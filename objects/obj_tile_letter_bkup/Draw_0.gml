...
if 1=1 {
	...
	image_alpha = 1
	image_blend = make_color_hsv(lerp(_letter_hue,145,am_selected_fd),lerp(80,180,am_selected_fd),clamp(70+(80*am_set_flash2)+(180*am_selected_flash2)+(40*am_selected_fd),0,255))
	...
	draw_set_alpha(lerp(0.6,1,clamp(am_selected_fd+am_clued_fd+(1*am_exed_fd),0,1)))
